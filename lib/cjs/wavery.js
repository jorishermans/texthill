...
exports.Wavery = void 0;
const _1 = require(".");
const utilities_1 = require("./utilities");
class Wavery {
    constructor(s) {
        this.s = s;
        this.configuration = new _1.WaveryConfiguration();
        this.normalizer = new _1.Normalizer();
        this._N = 0;
    }
    feedDoc(key, unstructuredDoc) {
        return __awaiter(this, void 0, void 0, function* () {
            // lookup if doc already exist
            const values = yield Promise.all([this.s.getItem("docs", {}),
            ...
            if (index != null) {
                ...
                for (let term of sentence.split(" ")) {
                    ...
                    if (index[term] != null && !this.configuration.skipWord(term)) {
                        if (docIdsRetrieval == null) {
                            ...
                            docIdsRetrieval = utilities_1.intersect(docIdsRetrieval, new Set(index[term]));
                        }
                    }
                }
                ...
                if (docIdsRetrieval != null) {
                    for (const docId of docIdsRetrieval) {
                        ...
                        findDocs.push(new _1.Score(totalScore, docId, docIds[`${docId}`]));
                    }
                }
            }
